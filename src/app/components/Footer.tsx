        ...
        <div className="container px-4 md:px-6">
          <div className="grid grid-cols-2 gap-10 md:grid-cols-4">
            <div className="space-y-3">
              ...
              <nav className="flex flex-col space-y-2">
                <Link href="#" className="text-sm text-[var(--foreground)] hover:text-foreground">
                  Features
                </Link>
                <Link href="#" className="text-sm text-[var(--foreground)] hover:text-foreground">
                  Pricing
          ...
          <div className="mt-10 flex flex-col items-center justify-between gap-4 border-t pt-6 md:h-24 md:flex-row">
            <p className="text-center text-sm text-[var(--foreground)] md:text-left">
              © {new Date().getFullYear()} Kaity&apos;s First Web App. All rights reserved.
            </p>
            <div className="flex items-center gap-4">
              <Link href="#" className="text-[var(--foreground)] hover:text-foreground">
                <svg
